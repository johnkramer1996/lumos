...
const CabinetCoursesLessons = () => {
   ...
   const fetchUserCourseRequest = useRequest({ request: fetchUserCourse, loading: true })
      ...
      <section className='lkp-course'>
         <div className='container'>
            <div className='course-top lkp-course__top'>
               <Breadcrumbs items={[{ to: getURL.cabinetCourses(null, rolesId), title: 'Мои курсы' }]} />
                  ...
                  <div className='lkp-course__left'>
                     ...
                     <div className='lkp-course__lesson card-bg'>
                        {modules.map((props, indexModule) => (
                           <CoursesLessonsGroup key={props.id || indexModule} {...props} currentLesson={currentLesson} courseId={courseId} rolesId={rolesId} />
                        ))}
                     </div>
                  </div>
