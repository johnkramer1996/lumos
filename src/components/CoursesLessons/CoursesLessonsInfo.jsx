...
const CoursesLessonsInfo = () => {
   ...
   return (
      <div className='lkp-course__card card-bg'>
         ...
         <Button to={getURL.cabinetCoursesLesson({ courseId, lessonId: currentLesson.id }, rolesId)} className='lkp-course__card-continue' link>
            <NextSvg />
            <span>Продолжить обучение</span>
         </Button>
         <Button to={getURL.coursesItem({ courseId }, rolesId)} className='lkp-course__card-link' outline link>
