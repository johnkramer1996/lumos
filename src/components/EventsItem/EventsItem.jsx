                     ...
                     <LoaderWrapper isLoading={isLoading}>
                        ...
                        {isUserPage && hasAccess(rolesId, [ROLES.TRAINER]) && (
                           <>
                              ...
                              <Button to={`${getURL.cabinetEventsEdit({ eventId })}`} className='event-page__card-btn event-page__card-btn--edit btn' outline link>
                                 <EditSvg />
                     ...
                     <div className='event-page__top'>
                        {isUserPage && hasAccess(rolesId, [ROLES.TRAINER]) && (
                           <div className='breadcrumbs'>
                              <Link to={getURL.cabinetEvents()} className='breadcrumbs__item'>
                                 Мои мероприятия
                              </Link>
                           </div>
                        )}
