...
const AddCourseModule = ({ course_id, id, hidden_id, index, name, onDelete, setName, ...rest }) => {
    return (
        <div className='create-module__item form-group'>
            ...
            <div className='create-module__input'>
                ...
                <button className='create-module__delete' onClick={() => onDelete(course_id, id, index)}>
